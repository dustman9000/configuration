...
const (
	...
	lokiVersion = "177faa651b8678f7122500641e29aa009e096e80"
	...
	lokiOperatorVersion = "157c2b41c918d4890ce7879f1e8583b6a50ec8a4"

	// lokiOperatorCRDRef is the commit ref used to sync the Loki Operator CRDs
	// from the github.com/openshift/loki repository. It comes from the
	// rhobs-konflux-loki-operator repository.
	// This is generated by mage sync:konflux and should not be modified manually in normal circumstances.
	lokiOperatorCRDRef = "935fed5e6fa5e292239407c9f1390c0de99f6c66"
)
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					Containers: []corev1.Container{{
						Name:            "manager",
						Image:           fmt.Sprintf("%s:%s", lokiOperatorImage, lokiOperatorVersion),
